...
from .local_diff_provider import LocalDiffProvider
...
---
*Generated by [cased kit](https://github.com/cased/kit) v{self._get_kit_version()} • Mode: agentic (max turns: {max_turns}) • Model: {self.config.llm.model}*
"""
        return comment
