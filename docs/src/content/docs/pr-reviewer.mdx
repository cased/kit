...
| **gpt-4.1-mini** | **$0.019** | ⭐⭐⭐⭐ | Budget-friendly |
| **gpt-4.1** | **$0.10** | ⭐⭐⭐⭐ | Good value |
| **gpt-4o-mini** | **$0.006** | ⭐⭐⭐⭐ | Surprising for the cost |
| **claude-sonnet-4** | **$0.14** | ⭐⭐⭐⭐⭐ | **Recommended** |

### Rough Monthly Cost Examples, standard mix

| Team Size | Budget Model | Recommended 
|-----------|--------------|-------------
| **Small** (20 PRs/month) | $0.12 | $3.00 
| **Medium** (100 PRs/month) | $0.60 | $12
| **Larger** (500 PRs/month) | $2.50 | $70
