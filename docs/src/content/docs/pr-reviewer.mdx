...
Use almost any LLM and pay just for tokens. High-quality reviews with SOTA models like Claude Sonnet 4.5 generally cost about 10 cents, while summaries cost just pennies.
...
<Aside type="tip">
**Just want the PR reviewer?** The base `uv pip install cased-kit` gives you everything needed for PR reviews without heavy ML dependencies like PyTorch. If you need semantic search features later, install with `uv pip install cased-kit[ml]`.
</Aside>
...
| **gpt-4.1-mini** | **$0.005-0.015** | ⭐⭐⭐⭐ | Budget-friendly, great value |
| **gemini-2.5-flash** | **$0.007** | ⭐⭐⭐⭐ | Excellent value, fast |
| **claude-haiku-4-5** | **$0.03** | ⭐⭐⭐⭐ | Ultra-fast and economical |
| **gpt-5.1** | **$0.05-0.10** | ⭐⭐⭐⭐⭐ | Latest OpenAI, very capable |
| **claude-sonnet-4-5** | **$0.08-0.18** | ⭐⭐⭐⭐⭐ | **Recommended for most** |
| **grok-4-1-fast-reasoning** | **$0.10-0.20** | ⭐⭐⭐⭐⭐ | Tool calling, agentic workflows |
