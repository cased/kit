...
**Note:** The tenant must be a valid UUID. Kit will validate the format and provide a clear error if an invalid tenant is provided. Find your tenant UUID in your [Chroma Cloud dashboard](https://cloud.trychroma.com).
