---
title: Context Assembly (LLM Prompts)
---
...
* **Token limits** – GPT-4o tops out at ~128k tokens; most models much less.
...
See the docstrings in `kit.llm_context.ContextAssembler` for full signatures and more details.
