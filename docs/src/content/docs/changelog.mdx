...
- **Kit Dev MCP Server**
  ...
  - New documentation site at https://kit-dev.cased.com
...
- MCP server command changed from `kit-mcp` to `kit-mcp-local-dev`
- Restructured MCP server implementation for enhanced capabilities

### Documentation

- New dedicated MCP documentation site at https://kit-dev.cased.com
