---
title: "Using Ollama with kit"
description: "Complete guide to using kit with Ollama for free local AI code analysis."
---

# Using Ollama with Kit

**Kit** has first-class support for **free local AI models** via [Ollama](https://ollama.com/). No API keys, no costs, no data leaving your machine.
