---
title: Repository API & primary interface
---

This page details the core methods available on the `kit.Repository` object.
...
repo = Repository(path_or_url="/path/to/local/project")
